  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .detail-info {
      ...
      border: 1px solid var(--line);
      border-radius: 8px;
      background: oklch(98.6% 0.007 250);
    }
    ...
    @media (max-width: 620px) {
      ...
      .series-detail-body { padding: 14px; }
      .detail-layout {
      ...
      .detail-info .title-row { grid-template-columns: 1fr; }
      .detail-title-actions { justify-content: space-between; }
      .detail-synopsis { min-height: 0; }
      .detail-synopsis,
      .detail-season-panel {
        padding: 14px;
      }
      ...
      seriesDetailBody.innerHTML = `
        <div class="detail-layout">
          ...
          <section class="detail-info" aria-labelledby="seriesDetailTitle">
            ...
            <div class="card-actions">
              <span class="rank">#${escapeText(item.rank || "-")} in ${escapeText(item.year || "-")}</span>
            </div>
          </section>
